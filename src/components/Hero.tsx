  ...
  return (
    <section className="relative flex min-h-[88svh] flex-col justify-center pb-10 pt-24">
      ...
      <motion.div variants={container} initial="hidden" animate="show">
        ...
        <motion.p
          variants={item}
          className="mt-6 max-w-2xl text-base leading-relaxed text-fog"
        >
          <span className="text-bright">Context-aware AI assistants</span>,{" "}
          <span className="text-bright">real-time multiplayer game systems</span>,{" "}
          <span className="text-bright">computer-vision pipelines</span>,{" "}
          <span className="text-bright">backend services</span> and{" "}
          <span className="text-bright">mobile apps</span> — products that{" "}
          <span className="text-mint">turn data into action</span>.
        </motion.p>

        <motion.p
          variants={item}
          className="mt-3 max-w-2xl text-base leading-relaxed text-fog/90"
        >
          A CS fresher with hands-on projects across backend systems, applied
          AI / ML, full-stack development and real-time systems — plus
